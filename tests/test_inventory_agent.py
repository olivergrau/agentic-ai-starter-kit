...
test_items = [
    QuoteItem(name="Thermal insulation sheet", quantity=1000, unit_price=2.75),
    QuoteItem(name="EVA helmet light", quantity=5, unit_price=6.00),
    QuoteItem(name="Portable power node", quantity=8, unit_price=18.00),
    QuoteItem(name="Carbon mesh panel", quantity=3, unit_price=5.00),
]
