...
from tools.db import init_database, db_engine
...
def run_test_scenarios():
    ...
    """
    print("🏗️  Polaris Outfitting Co. - FULL INTEGRATION TEST")
    print("=" * 65)
    
    print("\n🔧 Initializing Polaris Outfitting Database...")
    init_database(db_engine=db_engine, seed=0, debug=False)
    print("✅ Space mission supply database initialized successfully")
