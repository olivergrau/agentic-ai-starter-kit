...
def main():
    ...
    if args.init_db:
        ...
        # Search for polaris_outfitting.db files in current directory and db folder
        db_patterns = [
            "polaris_outfitting.db",           # Root directory
            "db/polaris_outfitting.db",        # db folder
            "**/polaris_outfitting.db"         # Any subdirectory (recursive)
        ]
